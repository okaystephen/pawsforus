...
const publicStorages = { local: localPublicStorage, cloud: cloudPublicStorage };

const fileUpload = multer({
  storage: publicStorages[filesystemsConfig.publicDriver](),
  preservePath: true,
});
